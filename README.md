...
With this repository, agents will be able to simulate fisheries and determine the reproductive rates of a fishing population. It will see the necessary steps, whether to maintain the population or harvest a select percentage. This will lead to full exploitation, which yields optimum food security and an environment that is sustainable and has reached maximum potential. By comparison, over-exploitation will result in unsustainable fisheries, and under-exploitation will result in a lack of food security. After some time, we will be able to simulate more real-world environments and ecosystems for other conservation and environmental issues. This project is meant to help Professor Boetigger of UC Berkeley in using machine learning techniques to solve these types of problems.
